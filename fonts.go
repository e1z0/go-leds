...
func (this *fontLT) GetCodePage() encoding.Encoding {
	return charmap.Windows1257
}

// helpful links for generating own fonts
// simple editor https://www.riyas.org/2013/12/online-led-matrix-font-generator-with.html
// simple editor used to generate these fonts http://xlr8.at/8x8hexbin/
// strings processing https://blog.golang.org/strings
// unicode and ascii tables https://play.golang.org/p/U3dlRahOxQN ftp://ftp.unicode.org/Public/MAPPINGS/VENDORS/MICSFT/WINDOWS/CP1252.TXT
// decimal to hex and wise versa https://www.rapidtables.com/convert/number/decimal-to-hex.html

func (this *fontLT) GetLetterPatterns() [][]byte {
	return [][]byte{
		...
		{0x47, 0x63, 0x71, 0x59, 0x4D, 0x67, 0x73, 0x00}, // 'Z' // ascii code 90
		...
		{0x4C, 0x64, 0x74, 0x5C, 0x4C, 0x64, 0x00, 0x00}, // 'z' // ascii code 122
		...
		{0x70, 0x78, 0x4C, 0x46, 0x4C, 0x78, 0x70, 0x00}, // 0x7F // ascii code 127
		{0x0E, 0x9F, 0x91, 0xB1, 0xFB, 0x4A, 0x00, 0x00}, // 0x80 // 128
		{0x3A, 0x7A, 0x40, 0x40, 0x7A, 0x7A, 0x40, 0x00}, // 0x81 // 129
		{0x38, 0x7C, 0x54, 0x55, 0x5D, 0x19, 0x00, 0x00}, // 0x82 // 130
		{0x02, 0x23, 0x75, 0x55, 0x55, 0x7D, 0x7B, 0x42}, // 0x83 // 131
		{0x21, 0x75, 0x54, 0x54, 0x7D, 0x79, 0x40, 0x00}, // 0x84 // 132
		{0x21, 0x75, 0x55, 0x54, 0x7C, 0x78, 0x40, 0x00}, // 0x85 // 133
		{0x20, 0x74, 0x57, 0x57, 0x7C, 0x78, 0x40, 0x00}, // 0x86 // 134
		{0x18, 0x3C, 0xA4, 0xA4, 0xE4, 0x40, 0x00, 0x00}, // 0x87 // 135
		{0x02, 0x3B, 0x7D, 0x55, 0x55, 0x5D, 0x1B, 0x02}, // 0x88 // 136
		{0x39, 0x7D, 0x54, 0x54, 0x5D, 0x19, 0x00, 0x00}, // 0x89 // 137
		{0x39, 0x7D, 0x55, 0x54, 0x5C, 0x18, 0x00, 0x00}, // 0x8A // 138
		{0x01, 0x45, 0x7C, 0x7C, 0x41, 0x01, 0x00, 0x00}, // 0x8B // 139
		{0x02, 0x03, 0x45, 0x7D, 0x7D, 0x43, 0x02, 0x00}, // 0x8C // 140
		{0x01, 0x45, 0x7D, 0x7C, 0x40, 0x00, 0x00, 0x00}, // 0x8D // 141
		{0x79, 0x7D, 0x16, 0x12, 0x16, 0x7D, 0x79, 0x00}, // 0x8E // 142
		{0x70, 0x78, 0x2B, 0x2B, 0x78, 0x70, 0x00, 0x00}, // 0x8F // 143
		{0x44, 0x7C, 0x7C, 0x55, 0x55, 0x45, 0x00, 0x00}, // 0x90 // 144
		...
		{0x32, 0x7A, 0x4A, 0x48, 0x78, 0x30, 0x00, 0x00}, // 0x95 // 149
		{0x3A, 0x7B, 0x41, 0x41, 0x7B, 0x7A, 0x40, 0x00}, // 0x96 // 150
		{0x3A, 0x7A, 0x42, 0x40, 0x78, 0x78, 0x40, 0x00}, // 0x97 // 151
		{0x9A, 0xBA, 0xA0, 0xA0, 0xFA, 0x7A, 0x00, 0x00}, // 0x98 // 152
		{0x01, 0x19, 0x3C, 0x66, 0x66, 0x3C, 0x19, 0x01}, // 0x99 // 153
		{0x3D, 0x7D, 0x40, 0x40, 0x7D, 0x3D, 0x00, 0x00}, // 0x9A // 154
		{0x18, 0x3C, 0x24, 0xE7, 0xE7, 0x24, 0x24, 0x00}, // 0x9B // 155
		{0x68, 0x7E, 0x7F, 0x49, 0x43, 0x66, 0x20, 0x00}, // 0x9C // 156
		{0x2B, 0x2F, 0xFC, 0xFC, 0x2F, 0x2B, 0x00, 0x00}, // 0x9D // 157
		{0xFF, 0xFF, 0x09, 0x09, 0x2F, 0xF6, 0xF8, 0xA0}, // 0x9E // 158
		{0x20, 0x74, 0x54, 0x54, 0x3c, 0x78, 0xc0, 0x00}, // 0x9F
		{0x7c, 0x7e, 0x13, 0x13, 0x7e, 0xfc, 0x80, 0x00}, // 0xA0 Ą (unicode \u0104) ascii 160 ok
		{0x38, 0x7c, 0x45, 0x45, 0x6d, 0x28, 0x00, 0x00}, // 0xA1
		{0x38, 0x7e, 0xc3, 0x83, 0x83, 0xc6, 0x44, 0x00}, // 0xA2 Č (unicode \u010c) ascii 162 ok
		{0x38, 0x7c, 0x54, 0x54, 0xdc, 0x98, 0x00, 0x00}, // 0xA3 ę (unicode \u0119) ascii 163 ok
		{0x41, 0x7f, 0x7f, 0x49, 0x5d, 0x41, 0xe3, 0x80}, // 0xA4 Ę (unicode \u0118) ascii 164 ok
		{0x38, 0x7c, 0x55, 0x55, 0x5c, 0x18, 0x00, 0x00}, // 0xA5
		{0x80, 0xfe, 0xfe, 0x93, 0xbb, 0x82, 0xc6, 0x00}, // 0xA6 Ė (unicode \u0116) ascii 166 ok
		{0x00, 0x44, 0x7d, 0x7d, 0xc0, 0x80, 0x00, 0x00}, // 0xA7 į (unicode \u012f) ascii 167 ok
		{0x00, 0x41, 0x7f, 0x7f, 0xc1, 0x80, 0x00, 0x00}, // 0xA8 Į (unicode \u012e) ascii 168 ok
		{0x48, 0x5c, 0x55, 0x55, 0x74, 0x24, 0x00, 0x00}, // 0xA9 š (unicode \u0161) ascii 169 ok
		{0x4c, 0xde, 0x9b, 0xb3, 0xe6, 0x64, 0x00, 0x00}, // 0xAA
		{0x3c, 0x7c, 0x40, 0x40, 0x3c, 0x7c, 0xc0, 0x80}, // 0xAB ų (unicode \u0173) ascii 171 ok
		{0x7f, 0x7f, 0x40, 0x40, 0x7f, 0xff, 0x80, 0x00}, // 0xAC Ų (unicode \u0172) ascii 172 ok
		{0x3c, 0x7c, 0x41, 0x41, 0x3c, 0x7c, 0x40, 0x00}, // 0xAD ū (unicode \u016b) ascii 173 ok
		{0xfc, 0xfc, 0x81, 0x81, 0xfc, 0xfc, 0x00, 0x00}, // 0xAE Ū (unicode \u016a) ascii 174 ok
		{0x4c, 0x64, 0x75, 0x5d, 0x4c, 0x64, 0x00, 0x00}, // 0xAF
		{0x9c, 0xcc, 0xe5, 0xb5, 0x9d, 0xcc, 0xec, 0x00}, // 0xB0 Ž (unicode \u017d) ascii 176 ok
		{0x20, 0x74, 0x54, 0x54, 0x3c, 0x78, 0xc0, 0x00}, // 0xB1 ą (unicode \u0105) ascii 177 ok
		{0x38, 0x7c, 0x45, 0x45, 0x6d, 0x28, 0x00, 0x00}, // 0xB2 č (unicode \u010d) ascii 178 ok
		{0x38, 0x7c, 0x55, 0x55, 0x5c, 0x18, 0x00, 0x00}, // 0xB3 ė (unicode \u0117) ascii 179 ok
		{0x4c, 0xde, 0x9b, 0xb3, 0xe6, 0x64, 0x00, 0x00}, // 0xB4 Š (unicode \u0160) ascii 180 ok
		{0x4c, 0x64, 0x75, 0x5d, 0x4c, 0x64, 0x00, 0x00}, // 0xB5 ž (unicode \u017e) ascii 181 ok
		{0x0, 0x0, 0x0, 0x0, 0x0, 0xe0, 0x0, 0xe0},       // 0xB6 „ (unicode ) ascii 182 ok
		{0x7, 0x0, 0x7, 0x0, 0x0, 0x0, 0x0, 0x0},         // 0xB7 “ (unicode ) ascii 283 ok
